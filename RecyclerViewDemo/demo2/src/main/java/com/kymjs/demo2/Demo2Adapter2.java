...
public class Demo2Adapter2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private final Context mContext;
    private ArrayList<Data> mTitles;

    public Demo2Adapter2(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 2:
            default:
                vh = new ImageViewHolder(View.inflate(mContext, R.layout.item_text, null));
                break;
        }
        return vh;
    }
